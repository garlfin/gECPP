...
#define GET_REGULAR(TYPE, ACCESSOR, FIELD) NODISCARD ALWAYS_INLINE TYPE Get##ACCESSOR() { return FIELD; }

#define GET(TYPE, ACCESSOR, FIELD) \
	GET_REGULAR(TYPE, ACCESSOR, FIELD) \
	GET_CONST(const TYPE, ACCESSOR, FIELD)

#define GET_VALUE(TYPE, ACCESSOR, FIELD) GET_CONST(TYPE, ACCESSOR, FIELD) // alias
