...
namespace GL
{
	...
	{
	 public:
		inline explicit FrameBuffer(gE::Window* win) : Asset(win)
		{ glCreateFramebuffers(1, &ID); }

		inline void Bind() const override
		{ glBindFramebuffer(GL_FRAMEBUFFER, ID); }

		ALWAYS_INLINE void SetDepthAttachment(Attachment* h)
		{ h->Attach(this, GL_DEPTH_ATTACHMENT, 0); }
