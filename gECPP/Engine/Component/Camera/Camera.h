...
namespace gE
{
	...
	{
	 public:
		Camera(Entity*, IComponentManager*, GL::TextureSize2D, IRenderTarget&, const ICameraSettings&);
	...
	class Camera2D : public Camera
	{
	 public:
		...
		Camera2D(Entity*, IComponentManager*, TARGET_TYPE&, const CameraSettings2D&);
	...
	{
	 public:
		PerspectiveCamera(Entity*, IComponentManager*, TARGET_TYPE&, const PerspectiveCameraSettings&);
	...
	{
	 public:
		OrthographicCamera(Entity*, IComponentManager*, TARGET_TYPE&, const OrthographicCameraSettings&);
	...
	class Camera3D : public Camera
	{
	 public:
		...
		Camera3D(Entity*, IComponentManager*, TARGET_TYPE&, const CameraSettings3D&);
	...
	class CameraCubemap : public Camera
	{
	 public:
		...
		CameraCubemap(Entity*, IComponentManager*, TARGET_TYPE&, const CameraSettings1D&);
