...
struct VR_IVRCompositor_FnTable
{
	...
	EVRCompositorError (__stdcall *SubmitWithArrayIndex)( EVREye eEye, const Texture_t *pTexture, uint32_t unTextureArrayIndex,
...
public:
	...
	*/
	...
	EVRCompositorError SubmitWithArrayIndex( EVREye eEye, const Texture_t *pTexture, uint32_t unTextureArrayIndex,
		const VRTextureBounds_t *pBounds = 0, EVRSubmitFlags nSubmitFlags = Submit_Default ) { return _table.SubmitWithArrayIndex(eEye, pTexture, unTextureArrayIndex, pBounds, nSubmitFlags); }
...
static const char * const IVRCompositor_Version = "FnTable:IVRCompositor_028";
...
namespace vr
{
	...
	public:
		...
		* Usually the size will be much smaller. */
		...
		EVRInputError GetActionBindingInfo( VRActionHandle_t action, VR_ARRAY_COUNT( unBindingInfoCount ) InputBindingInfo_t *pOriginInfo, uint32_t unBindingInfoSize, uint32_t unBindingInfoCount, uint32_t *punReturnedBindingInfoCount ) { return _table.GetActionBindingInfo(action, pOriginInfo, unBindingInfoSize, unBindingInfoCount, punReturnedBindingInfoCount); }
...
static const uint64_t k_ulInvalidIOBufferHandle = 0;
	...
	static const char * const IVRIOBuffer_Version = "FnTable:IVRIOBuffer_002";
}
